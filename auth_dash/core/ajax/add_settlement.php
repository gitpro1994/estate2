...
if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && !empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest')
{
    ...
    $settlement     = clean($_POST['settlement_name']);
	...
	{		
		...
		$sql 		= "INSERT INTO settlements (region_id,settlement_name,seo_link,status,created_at) 
		VALUES('".$region."', '".$settlement."', '".seo($settlement)."', '".$status."', '".$now."')";
