 ...
 */
	...
	function I_Insert() {
        ...
        if (youtput == 'placeholder')
            ...
            var sHTML = '<a href="' + sEmbedUrl + '?hl=nl&amp;showsearch=0&amp;wmode=opaque&amp;iv_load_policy=3&amp;color=' + $('#skinURL').val() + '&amp;modestbranding=1&amp;showinfo=0&amp;rel=0&amp;autoplay=1&amp;border=0" class="imglink youtubetip" data-rel="youtube" title="video - ' + sTitle + '"><img width="' + $('#widthURL').val() + '" height="' + $('#heightURL').val() + '" alt="Klik hier om de video af te spelen" class="youtubethumb ybig" src="' + secure + '://img.youtube.com/vi/' + getVideoId($('#inpURL').val()) + '/mqdefault.jpg"></a>';
