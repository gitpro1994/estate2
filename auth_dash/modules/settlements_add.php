   ...
   <div class="content-wrapper">
      ...
      <div class="row">
         <div class="col-md-12 grid-margin">
            <div class="card">
               <div class="card-body">
                  <form class="forms-sample" id="settlement_add_form" method="post" action="" enctype="multipart/form-data">
                     <div class="form-group">
                        <label for="settlement_name"><?= translate('settlement_name') ?></label>
                        <input type="text" class="form-control form-control-sm" name="settlement_name" id="settlement_name" value="">
                     </div>                    
                     <div class="form-group">
                     ...
                     <button id="add_settlement" type="submit" name="add_settlement" class="btn btn-primary btn-icon-text btn-sm">
