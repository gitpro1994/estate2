      ...
      <div class="page-title mt-0 mb-0">
         ...
         <div class="crumbs">
            <ul id="breadcrumbs" class="breadcrumb">
               ...
               <li class="active"><a href="#"><?= translate('slide_list') ?></a></li>
            </ul>
         </div>
      </div>
            ...
            <div class="row mb-3">
               <div class="col-lg-12">
                  <div class="btn-toolbar" role="toolbar">
                     <a href="<?= base_url() ?>/slide_add" class="btn btn-primary btn-sm mr-1">
                        <i class="icon-plus font-12"></i> <?= translate("add_new_slide") ?>				
                     </a>
                     ...
                     <table id="order-listingg" class="table table-bordered table-hover">
                        <thead class="headbg">
                           <tr>
                              ...
                              <th><?= translate('slide_title') ?></th>
                              <th style="width:150px;"><?= translate('slide_text') ?></th>
                              <th style="width:90px;"><?= translate('slide') ?> URL</th>
                              <th style="width:70px;"><?= translate('video_url') ?></th>
      	...
      	$("#sortable").sortable({
      		...
      		stop: function(event, ui){
      			...
      			$.ajax({
      				...
      				dataType: "json",
      				data: data,
      				url: "core/data/control.php?slider_order=orderable",
