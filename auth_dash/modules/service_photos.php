		...
		<div class="page-title mt-0 mb-0">
			...
			<div class="crumbs">
				<ul id="breadcrumbs" class="breadcrumb">
					...
					<li><a href="<?= base_url() ?>/service_list">"<?=$title ?>"</a></li>
					<li class="active"><a href="#"><?= translate('services_photos') ?></a></li>
				</ul>
			</div>
		</div>
	</div>
	<?php 
	$albom  = "SELECT * FROM services_photos WHERE service_id='".$id."'";
					...
					<?php 
						if (isset($_POST['haberfoto_ekle'])) {
							...
							foreach($_FILES["resimler"]["tmp_name"] as $key => $tmp_name) {
							    ...
							    $yeri           = '../assets/uploads/service_gallery/';


							    if(in_array($ext,$extension)) {
							        move_uploaded_file($file_tmp,$yeri.$file_name); 
				            		$insert = mysqli_query($conn,"INSERT INTO services_photos (photo_src,service_id) VALUES ('".$file_name."','".$id."')"); 
							    }
							    else {
					...
					<div class="row portfolio-grid">
						...
						<div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12">
							<figure class="proje_resim_box">
								...
								<img src="../../assets/uploads/service_gallery/<?=$show['photo_src'] ?>" style="height:170px;" alt="image">
							</figure>
						</div>
