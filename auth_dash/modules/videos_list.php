            ...
            <div class="row mb-3">
               <div class="col-lg-12">
                  <div class="btn-toolbar" role="toolbar">
                     <a href="<?= base_url() ?>/add_video" class="btn btn-primary btn-sm mr-1">
                        <i class="icon-plus font-12"></i> <?= translate("add_new_video") ?>				
                     </a>
      ...
      $(document).ready(function(){
      	var dataTable=$('#order-listingg').DataTable({
      		...
      		"columnDefs": [
      			...
      			{  "className": "secili text-center", targets: [1,2,3] },
