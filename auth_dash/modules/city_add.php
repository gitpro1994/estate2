   ...
   <div class="content-wrapper">
         ...
         <div class="page-title mt-0 mb-0">
            ...
            <div class="crumbs">
               <ul id="breadcrumbs" class="breadcrumb">
                  ...
                  <li class="active"><a href="#"><?= translate('add_new_city') ?></a></li>
               </ul>
            </div>
         </div>
      ...
      <div class="row">
         <div class="col-md-12 grid-margin">
            <div class="card">
               <div class="card-body">
                  <form class="forms-sample" id="city_add_form" method="post" action="" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="city_name" id="city_name" value="">
                     </div>
                     ...
                     <button id="add_city" type="submit" name="add_city" class="btn btn-primary btn-icon-text btn-sm">
