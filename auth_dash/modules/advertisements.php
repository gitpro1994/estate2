         ...
         <div class="page-title mt-0 mb-0">
            ...
            <div class="crumbs">
               <ul id="breadcrumbs" class="breadcrumb">
                  ...
                  <li><a href="#"><?= translate('all_listings') ?></a></li>
                  <li class="active"><a href="#"><?= translate('advertisements') ?></a></li>
               </ul>
            </div>
         </div>
      ...
      <script>
         $(document).ready(function() {
            var dataTable = $('#order-listingg').DataTable({
               ...
               "serverSide": true,
               "ajax": {
                  url: "core/data/advertisements.php",
                  type: "post"
               },
               "order": [
                  [1, "asc"]
