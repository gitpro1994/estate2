            ...
            <div class="page-title mt-0 mb-0">
                ...
                <div class="crumbs">
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class="active"><a href="#"><?= translate('cities_list') ?></a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="btn-toolbar" role="toolbar">
                                <a href="<?= base_url() ?>/add_user" class="btn btn-primary btn-sm mr-1">
                                    <i class="icon-plus font-12"></i> <?= translate("add_user") ?>
                                </a>
                                <div class="dropdown mr-1">
                                    ...
                                    <div class="dropdown-menu p-0 min-width-full" aria-labelledby="dropdownMenuSizeButton3">
                                        <button class="dropdown-item p-2 cursor-pointer" type="submit" name="user_activate"><i class="icon-check"></i> <?= translate("activate_selected") ?></button>
                                        <button class="dropdown-item p-2 cursor-pointer" type="submit" name="user_deactive"><i class="icon-close"></i> <?= translate("deactivate_selected") ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
