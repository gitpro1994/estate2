   ...
   <div class="content-wrapper">
      ...
      <div class="row">
         <div class="col-md-12 grid-margin">
            <div class="card">
               <div class="card-body">
                  <form class="forms-sample" id="hashtag_edit_form" method="post" action="" enctype="multipart/form-data">
                     <div class="form-group">
                        <label for="hashtag_name"><?= translate('hashtag_name') ?></label>
                        <input type="text" class="form-control form-control-sm" name="hashtag_name" id="hashtag_name" value="<?= hashtagById($_GET['id'],'hashtag_name') ?>">
                     </div>                    
                     <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" id="region" name="region">
                           ...
                           <?php 
                             $cid = hashtagById($_GET['id'],'region_id');
                      ...
                      <input type="hidden" name="hashtag_id" id="hashtag_id" value="<?= $_GET['id'] ?>">
                     <div class="form-group mb-2">
                      <?php $status = (hashtagById($_GET['id'],'status')==1) ? 'checked' : ''; ?>						
                        <label class="switch">
                     ...
                     <button id="edit_hashtag" type="submit" name="edit_hashtag" class="btn btn-primary btn-icon-text btn-sm">
