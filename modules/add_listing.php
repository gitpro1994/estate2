                     ...
                     <div class="form-group mb-3 row">
                        ...
                        <div class="col-sm-8">
                           <select class="js-example-basic-single form-control form-control-sm" id="type" name="user_kind" style="width:100%" required>
                              ...
                              <option value="0" <?= (users_info($_SESSION['id'], 'user_type') == 0 ? 'selected' : '') ?>><?= translate('share_my_listing') ?></option>
                              <option value="1" <?= (users_info($_SESSION['id'], 'user_type') == 1 ? 'selected' : '') ?>><?= translate('a_rielitor') ?></option>
                           </select>
                        </div>
                     </div>
