                                            ...
                                            <div class="property-box2 property-box4 wow animated fadeInUp" data-wow-delay=".6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                                                ...
                                                <div class="item-content item-content-property">
                                                    ...
                                                    <div class="item-categoery3">
                                                        <ul>
                                                            <li><i class="flaticon-bed"></i><?= translate('room') ?>: <?= $bax_all_listings['rooms'] ?></li>
                                                            <li><i class="flaticon-two-overlapping-square"></i><?= $bax_all_listings['area'] ?> m²</li>
                                                            <li><i class="fas fa-eye"></i> Baxış sayı<?= $bax_all_listings['seen'] ?></li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="property-box2 property-box4 wow animated fadeInUp" data-wow-delay=".6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                                                ...
                                                <div class="item-content item-content-property">
                                                    ...
                                                    <div class="item-categoery3">
                                                        <ul>
                                                            <li><i class="flaticon-bed"></i><?= translate('room') ?>: <?= $bax_inspection['rooms'] ?></li>
                                                            <li><i class="flaticon-two-overlapping-square"></i><?= $bax_inspection['area'] ?> m²</li>
                                                            <li><i class="fas fa-eye"></i><?= $bax_inspection['seen'] ?></li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="property-box2 property-box4 wow animated fadeInUp" data-wow-delay=".6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                                                ...
                                                <div class="item-content item-content-property">
                                                    ...
                                                    <div class="item-categoery3">
                                                        <ul>
                                                            <li><i class="flaticon-bed"></i><?= translate('room') ?>: <?= $bax_expired['rooms'] ?></li>
                                                            <li><i class="flaticon-two-overlapping-square"></i><?= $bax_expired['area'] ?> m²</li>
                                                            <li><i class="fas fa-eye"></i><?= $bax_expired['seen'] ?></li>
                                                        </ul>
                                                    </div>
