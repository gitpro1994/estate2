                                ...
                                <div class="col-md-8">
                                    <div class="list-single-main-wrapper fl-wrap">
                                        ...
                                        <div class="scroll-nav-wrap">
                                            <nav class="scroll-nav scroll-init fixed-column_menu-init" style="z-index: 20; position: absolute; top: 0px;">
                                        ...
                                        <div class="list-single-main-media fl-wrap">
                                            <div class="single-slider-wrapper carousel-wrap fl-wrap">
                                                <div class="slider-for fl-wrap carousel lightgallery"  >
                                                    ...
                                                    <div class="slick-slide-item">
                                                        <div class="box-item">
                                                            <a href="<?= site_url() ?>/assets/images/all/1.jpg" class="gal-link popup-image"><i class="fal fa-search"  ></i></a>
                                                    ...
                                                    <div class="slick-slide-item">
                                                        <div class="box-item">
                                                            <a href="<?= site_url() ?>/assets/images/all/2.jpg" class="gal-link popup-image"><i class="fal fa-search"  ></i></a>
                                                            <img src="<?= site_url() ?>/assets/images/all/2.jpg" alt="">
                                                        </div>
                                                    </div>
                                                    <!--  slick-slide-item end -->
                                                    <!--  slick-slide-item -->
                                                    <div class="slick-slide-item">
                                                        <div class="box-item">
                                                            <a href="<?= site_url() ?>/assets/images/all/3.jpg" class="gal-link popup-image"><i class="fal fa-search"  ></i></a>
                                                    ...
                                                    <div class="slick-slide-item">
                                                        <div class="box-item">
                                                            <a href="<?= site_url() ?>/assets/images/all/4.jpg" class="gal-link popup-image"><i class="fal fa-search"  ></i></a>
                                                            <img src="<?= site_url() ?>/assets/images/all/4.jpg" alt="">
                                                        </div>
                                                    </div>
                                                    <!--  slick-slide-item end -->
                                                </div>
                                            ...
                                            <div class="single-slider-wrapper fl-wrap">
                                                <div class="slider-nav fl-wrap">
                                                    <div class="slick-slide-item"><img src="<?= site_url() ?>/assets/images/all/1.jpg" alt=""></div>
                                                    <div class="slick-slide-item"><img src="<?= site_url() ?>/assets/images/all/2.jpg" alt=""></div>
                                                    <div class="slick-slide-item"><img src="<?= site_url() ?>/assets/images/all/3.jpg" alt=""></div>
                                                    <div class="slick-slide-item"><img src="<?= site_url() ?>/assets/images/all/4.jpg" alt=""></div>
                                                    <div class="slick-slide-item"><img src="<?= site_url() ?>/assets/images/all/5.jpg" alt=""></div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="rooms-container fl-wrap">
                                                    ...
                                                    <div class="rooms-item fl-wrap">
                                                        <div class="rooms-media">
                                                            <img src="<?= site_url() ?>/assets/images/all/10.jpg" alt="">
                                                            <div class="dynamic-gal more-photos-button color-bg" data-dynamicPath="[{'src': '<?= site_url() ?>/assets/images/all/10.jpg'}, {'src': '<?= site_url() ?>/assets/images/all/2.jpg'},{'src': '<?= site_url() ?>/assets/images/all/3.jpg'}]"><i class="fas fa-camera"></i> <span>3 photos</span>  </div>
                                                        </div>
                                                    ...
                                                    <div class="rooms-item fl-wrap">
                                                        <div class="rooms-media">
                                                            <img src="<?= site_url() ?>/assets/images/all/11.jpg" alt="">
                                                            <div class="dynamic-gal more-photos-button color-bg" data-dynamicPath="[{'src': '<?= site_url() ?>/assets/images/all/11.jpg'}, {'src': '<?= site_url() ?>/assets/images/all/12.jpg'} ]"><i class="fas fa-camera"></i> <span>2 photos</span>  </div>
                                                        </div>
                                                        <div class="rooms-details">
                                                            <div class="rooms-details-header fl-wrap">
                                                    ...
                                                    <div class="rooms-item fl-wrap">
                                                        <div class="rooms-media">
                                                            <img src="<?= site_url() ?>/assets/images/all/13.jpg" alt="">
                                                            <div class="dynamic-gal more-photos-button color-bg" data-dynamicPath="[{'src': '<?= site_url() ?>/assets/images/all/13.jpg'}, {'src': '<?= site_url() ?>/assets/images/all/14.jpg'},{'src': '<?= site_url() ?>/assets/images/all/15.jpg'}]"><i class="fas fa-camera"></i> <span>3 photos</span>  </div>
                                                        </div>
                                                        <div class="rooms-details">
                                                            <div class="rooms-details-header fl-wrap">
                                            ...
                                            <div class="list-single-main-item fl-wrap">
                                                ...
                                                <div class="accordion">
                                                    ...
                                                    <div class="accordion-inner visible">
                                                        <img src="<?= site_url() ?>/assets/images/plans/1.jpg" alt="">
                                                    ...
                                                    <div class="accordion-inner">
                                                        <img src="<?= site_url() ?>/assets/images/plans/2.jpg" alt="">
                                                    ...
                                                    <div class="accordion-inner">
                                                        <img src="<?= site_url() ?>/assets/images/plans/3.jpg" alt="">
                                            ...
                                            <div class="list-single-main-item fl-wrap" id="sec4">
                                                ...
                                                <div class="list-single-main-item_content fl-wrap">
                                                    <div class="video-box fl-wrap">
                                                        <img src="<?= site_url() ?>/assets/images/all/7.jpg" class="respimg" alt="">
