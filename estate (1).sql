...
(436, 'contac', 'Contac', '', '', '', '', '', '', ''),
(437, 'floor_no', 'Floor no', '', '', '', '', '', '', ''),
(438, 'enter_floor_number', 'Enter floor number', '', '', '', '', '', '', ''),
(439, 'building_floor_no', 'Building floor no', '', '', '', '', '', '', ''),
(440, 'enter_building_floor_no', 'Enter building floor no', '', '', '', '', '', '', ''),
(441, 'description', 'Description', '', '', '', '', '', '', ''),
(442, 'enter_description', 'Enter description', '', '', '', '', '', '', ''),
(443, 'by_agreement', 'By agreement', '', '', '', '', '', '', ''),
(444, 'room', 'Room', '', '', '', '', '', '', ''),
(445, 'Alqı satqı', 'Alqı satqı', '', '', '', '', '', '', ''),
(446, 'sell', 'Sell', '', '', '', '', '', '', ''),
(447, 'advanced_search', 'Advanced search', '', '', '', '', '', '', ''),
(448, 'enter_keyword_for_search', 'Enter keyword for search', '', '', '', '', '', '', ''),
(449, 'latest_listings', 'Latest listings', '', '', '', '', '', '', ''),
(450, 'Axtardığınız kateqoriyaya uyğun elan tapılmadı...', 'Axtardığınız kateqoriyaya uyğun elan tapılmadı...', '', '', '', '', '', '', ''),
(451, 'cavid', 'Cavid', '', '', '', '', '', '', ''),
(452, 'alis', 'Alis', '', '', '', '', '', '', ''),
(453, 'kiraye', 'Kiraye', '', '', '', '', '', '', ''),
(454, 'Search_Results_Found', 'Search Results Found', '', '', '', '', '', '', ''),
(455, 'sort_by', 'Sort by', '', '', '', '', '', '', ''),
(456, 'by_date', 'By date', '', '', '', '', '', '', ''),
(457, 'cheap_at_first', 'Cheap at first', '', '', '', '', '', '', ''),
(458, 'expensive_at_first', 'Expensive at first', '', '', '', '', '', '', ''),
(459, 'all_types', 'All types', '', '', '', '', '', '', ''),
(460, 'for_sell', 'For sell', '', '', '', '', '', '', ''),
(461, 'for_rent', 'For rent', '', '', '', '', '', '', ''),
(462, 'favourite', 'Favourite', '', '', '', '', '', '', ''),
(463, 'terms_&_conditions', 'Terms & conditions', '', '', '', '', '', '', ''),
(464, 'search_with_estate_number', 'Search with estate number', '', '', '', '', '', '', ''),
(465, 'chixarish', 'Chixarish', '', '', '', '', '', '', ''),
(466, '', '', '', '', '', '', '', '', ''),
(467, 'cheap_firstly', 'Cheap firstly', '', '', '', '', '', '', ''),
(468, 'expensive_firstly', 'Expensive firstly', '', '', '', '', '', '', ''),
(469, 'jhsgdfjgsdfsd', 'Jhsgdfjgsdfsd', '', '', '', '', '', '', ''),
(470, 'there_is_no_user', 'There is no user', '', '', '', '', '', '', ''),
...
(1, 'Ağakərim', 'Kərimov', 'admin@gmail.com', 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', 'bf2c47223aeab03eb14749cc1a07fddffaa208f4158ca9a486a30f36118f83e0', 'avatar686.png', '2022-02-20 21:34:00', 'http://127.0.0.1:8080/estate2//auth_dash/moduls', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36', 1, '2DDF575071031B4BAE68F0BF76AF7703D55489542A31873483374EBBE8C04366C0B779C9583B4CC0377EE8FD57C4116321BD5F341E92052D0AE6EF74F9D8A3C9');
...
INSERT INTO `realty_kinds` (`id`, `kind_name`, `seo_link`, `icons`, `status`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'Alqı satqı', 'alis', 'fa fa-coins icon-round', 1, NULL, '2022-01-27 14:47:11', '2022-02-03 10:03:45'),
(2, 'Kirayə', 'kiraye', 'fa fa-retweet icon-round', 1, NULL, '2022-01-27 14:47:11', '2022-01-27 14:47:11');
